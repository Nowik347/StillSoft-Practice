...
{                                                                    // Работа словаря g_dictionary[флаг страницы][флаг абзаца][строка][слово]
    {                                                                                                                                       // [флаг страницы] - используется
        {                                                                                                                                   // в основном для работы исключений
            { "", " один", " два", " три", " четыре", " пять", " шесть", " семь", " восемь", " девять" },                                   // [флаг абзаца] - позволяет различать
            { "", " десять", " двадцать", " тридцать", " сорок", " пятьдесят", " шестьдесят", " семьдесят", " восемьдесят", " девяносто" }, // между тысячами и остальными разрядами
            { "", " сто", " двести", " триста", " четыреста", " пятьсот", " шестьсот", " семьсот", " восемьсот", " девятьсот" }             // [строка][слово] - используются для
        },                                                                                                                                  // непосредственной работой с введеными числами
        {
